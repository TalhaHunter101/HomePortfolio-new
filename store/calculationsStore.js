...
export const useCalculationsStore = create((set) => ({
  ...
  propertyManagementFeePercentage: 12,
  serviceCharge: 0,
  groundRent: 0,
  insurance: 0,
  utilities: 0,
  ...
  cashOnCash: 0,
    ...
    setMortgagePayment: (mortgagePayment) => set({ mortgagePayment }),
    ...
    setInitialExpenses: (initialExpenses) => set({initialExpenses}),
    ...
    setTotal_cash_invested: (total_cash_invested) => set({ total_cash_invested }),
