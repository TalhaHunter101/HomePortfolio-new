...
export function SchoolsCard({ title, }) {
    return (
        <Card className="m-4" style={{ minHeight: '150px' }}>
            ...
            <CardBody>
                <div className=" items-center  border border-subtle-border p-4 sm:p-4 sm:py-6 lg:flex relative cursor-pointer overflow-hidden data-report-preview scroll-m-6 lg:scroll-m-8 bg-background text-foreground rounded-t-lg">
                    ...
                    <h2 className="w-full  pr-10 lg:pr-4 relative z-10 lg:w-1/2 mb-3 lg:mb-0 flex items-start space-x-2 sm:space-x-4 font-semibold capitalize space-x-2 text-foreground mb-2 sm:mb-4 text-lg">
                        <div className="h-6 w-6 lg:w-8 lg:h-8 flex justify-center items-center mr-1 rounded-full bg-purple-300">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width="1em" height="1em" fill="currentColor" stroke="currentColor" strokeWidth="0" className="inline-block text-sm md:text-md w-6 lg:w-8 text-foreground">
                    ...
                    <div className="sentences leading-6 w-full relative pr-2 sm:pr-10 md:pr-2 z-10 max-w-md mt-4 md:mt-0 text-foreground grid item-start sm:items-center grid-cols-2">
                        <div className="flex flex-col items-start md:items-center mb-2 pr-2 text-center justify-between">
                            <div className="text-xs md:text-sm capitalize text-foreground">Simi Valley Avg</div>
                        ...
                        <div className="flex flex-col items-center mb-2 pr-2 text-center justify-between">
                            <div className="text-xs md:text-sm capitalize text-foreground">Nearby Avg</div>
                            <div className="text-xl text-muted-foreground font-medium">5/10</div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="flex-1  flex flex-col justify-end h-full">
                            ...
                            <div className="flex-1 w-1/2 overflow-x-scroll  scrollbar-none snap-mandatory space-x-2 pr-6 ml-2 mb-2 sm:w-full sm:flex-wrap sm:flex-col sm:space-x-0 sm:pr-0 sm:mb-0 sm:-mt-2">
                                <div className="flex flex-row sm:flex-col">
                                                ...
                                                <div className="flex flex-row items-center h-full space-x-4 truncate flex-1 w-full relative overflow-hidden text-foreground">
                                                    <div className="flex flex-row sm:flex-col">
                                                        ...
                                                        <div className="flex flex-col text-sm">
                                                            <p className="truncate text-base font-bold text-purple-800 pr-4" style={{ WebkitBoxOrient: 'vertical', WebkitLineClamp: 1, display: '-webkit-box' }} title="White Oak Elementary School">White Oak Elementary School</p>
                                                            <span>Public, K-6</span>
                                                            <div>0.49 mi away</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="flex-shrink-0 snap-start map-list-item mb-0 w-auto">
                                        <button className="w-full h-auto text-left pt-2 pr-2">
                                            <div className="relative flex flex-col h-full bg-white p-2 pl-6 border rounded-md sm:mr-2 sm:rounded-lg border-gray-150 bg-gray-100">
                                                <div className="flex flex-row items-center h-full space-x-4 truncate flex-1 w-full relative overflow-hidden text-foreground">
                                                    <div className="flex flex-row sm:flex-col">
                                                        <div className="text-4xl font-bold text-orange-500" style={{ minWidth: '45px' }}>3</div>
                                                        <div className="flex flex-col text-sm">
                                                            <p className="truncate text-base font-bold text-gray-800 pr-4" style={{ WebkitBoxOrient: 'vertical', WebkitLineClamp: 1, display: '-webkit-box' }} title="Knolls Elementary School">Knolls Elementary School</p>
                                                            <span>Public, K-6</span>
                                                            <div>0.68 mi away</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    {/* Continue adding other items similarly */}
                                </div>
                            </div>
