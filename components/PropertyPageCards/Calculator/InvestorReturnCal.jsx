    ...
    <div className="mt-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-center">
        <div className="shadow rounded-xl border border-purple-100 ">
          ...
          <p className="text-xl font-bold text-purple-900 mb-2  ">13.7%</p>
        </div>
        <div className="shadow rounded-xl border border-purple-100">
        ...
        <div className="shadow rounded-xl border border-purple-100">
          ...
          <p className="text-xl font-bold text-purple-900 mb-2">29.5%</p>
        </div>
        <div className="shadow rounded-xl border border-purple-100">
          <p className="text-gray-400 text-sm font-medium mt-2">Cash on Cash</p>
          <p className="text-xl font-bold text-purple-900 mb-2">29.5%</p>
        </div>
      </div>
    </div>
