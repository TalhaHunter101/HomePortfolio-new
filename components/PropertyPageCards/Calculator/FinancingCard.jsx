...
export default function FinancingCard() {
  ...
  }, [loanAmount, interestRate, mortgageTerm, interestType]);


  //calclation when Financing method changes
  useEffect(() => {
        ...
        >
          ...
          <div className="flex items-center">
            {monthlyPayment === 0 ? (
              ...
              <span className="text-xl font-bold text-purple-900 mr-2">£{monthlyPayment.toLocaleString('en-GB')}/mo</span>
            )}
            <Icon
        ...
        >
          <div className="p-4 space-y-4 grid grid-cols-2 gap-4">
            ...
            {financingMethod === "mortgage" && (
              <>
                <div>
                  <label className="block text-sm font-medium text-gray-500 mb-1">LTV</label>
                  <Slider
                    value={ltv}
                    onChange={(e) => setLtv(e)}
                    min={0}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseFloat(e.target.value.replace(/,/g, ''));
                      if (!isNaN(value) && value !== loanAmount) setLoanAmount(value);
                    }}
                    startContent={<div className="pointer-events-none text-gray-400">£</div>}
                  />
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-500 mb-1">Mortgage / Interest Rate</label>
                  <Slider
                    value={interestRate}
                    ...
                    max={30}
                    step={0.1}
                    endContent={<div className="pointer-events-none text-gray-400">{interestRate}%</div>}
                  />
                </div>

                {/* <div>
                  <label className="block text-sm font-medium text-gray-500 mb-1">Mortgage Fees</label>
                  <Slider
                    value={mortgageFees}
                ...
                {interestType === "capital_Interest" && (
                  <div>
                    <label className="block text-sm font-medium text-gray-500 mb-1">Mortgage Term (Years)</label>
                    <Slider
                      value={mortgageTerm}
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <Button
                      color="secondary"
                      variant={interestType === "capital_Interest" ? "solid" : "bordered"}
                    ...
                    <Button
                      color="secondary"
                      variant={interestType === "Interest_only" ? "solid" : "bordered"}
