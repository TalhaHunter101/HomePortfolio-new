...
export function BasicInfoCard({ title, content }) {
    return (
                ...
                <div class="px-16 py-5 bg-gray-100 border border-gray-200 rounded-md ">
                    ...
                    <div class="flex flex-wrap gap-4 my-5">
                        ...
                        <div class="flex items-center justify-center p-2 bg-gray-200 rounded-md ">
                            <svg width="1em" height="1em" fill="currentColor" stroke="currentColor" stroke-width="0" class="inline-block mr-2" viewBox="0 0 448 512">
                                <path stroke="none" d="M96 80a48 48 0 1 1 96 0 48 48 0 1 1-96 0zm1.7 206c6.2-2.3 11.8-6.3 15-12.2l40-71.9c14.4-25.9 41.7-42 71.3-42s56.9 16.1 71.3 42l40 71.9c3.2 5.8 8.8 9.9 15 12.2 38.3 14 65.7 50.8 65.7 94 0 55.2-44.8 100-100 100-21.2 0-40.8-6.6-56.9-17.8-17.4-12-52.8-12-70.1 0-16.2 11.2-35.8 17.8-57 17.8-55.2 0-100-44.8-100-100 0-43.2 27.4-80 65.7-94zM304 32a48 48 0 1 1 0 96 48 48 0 1 1 0-96zm48 160a48 48 0 1 1 96 0 48 48 0 1 1-96 0zM48 144a48 48 0 1 1 0 96 48 48 0 1 1 0-96z"></path>
                            </svg><p class="text-[12px] text-black font-medium ">Dog Friendly</p></div>
                        <div class="flex items-center justify-center p-2 bg-gray-200 rounded-md ">
                            <svg width="1em" height="1em" fill="currentColor" stroke="currentColor" stroke-width="0" class="inline-block mr-2" viewBox="0 0 512 512">
                                <path stroke="none" d="M288 96c0-17.7 14.3-32 32-32s32 14.3 32 32 14.3 32 32 32 32-14.3 32-32c0-53-43-96-96-96s-96 43-96 96v192h-64v-24c0-30.9-25.1-56-56-56H56c-13.3 0-24 10.7-24 24s10.7 24 24 24h48c4.4 0 8 3.6 8 8v24H32c-17.7 0-32 14.3-32 32s14.3 32 32 32h448c17.7 0 32-14.3 32-32s-14.3-32-32-32h-80v-24c0-4.4 3.6-8 8-8h56c13.3 0 24-10.7 24-24s-10.7-24-24-24h-56c-30.9 0-56 25.1-56 56v24h-64V96zm192 320v-32H32v32c0 53 43 96 96 96h256c53 0 96-43 96-96z"></path>
                            </svg><p class="text-[12px] text-black font-medium ">Stainless Steel Appliances</p></div>
                        <div class="flex items-center justify-center p-2 bg-gray-200 rounded-md ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" stroke="currentColor" stroke-width="0" class="inline-block mr-2" viewBox="0 0 512 512">
                                <path stroke="none" d="M256 512a256 256 0 1 0 0-512 256 256 0 1 0 0 512zm129-281c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-71-71V376c0 13.3-10.7 24-24 24s-24-10.7-24-24V193.9l-71 71c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9L239 119c9.4-9.4 24.6-9.4 33.9 0L385 231z"></path>
                            </svg><p class="text-[12px] text-black font-medium ">Upgraded Kitchen</p></div>
                        <div class="flex items-center justify-center p-2 bg-gray-200 rounded-md "><p class="text-[12px] text-black font-medium ">Nearby Parks Playgrounds</p></div>
                        <div class="flex items-center justify-center p-2 bg-gray-200 rounded-md ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" stroke="currentColor" stroke-width="0" class="inline-block mr-2" viewBox="0 0 640 512">
                                <path stroke="none" d="M400 96a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm27.2 64-61.8-48.8c-17.3-13.6-41.7-13.8-59.1-.3l-83.1 64.2c-30.7 23.8-28.5 70.8 4.3 91.6l60.5 38.4V416c0 17.7 14.3 32 32 32s32-14.3 32-32V288c0-10.7-5.3-20.7-14.2-26.6L295 232.9l60.3-48.5L396 217c5.7 4.5 12.7 7 20 7h64c17.7 0 32-14.3 32-32s-14.3-32-32-32h-52.8zM56 384a72 72 0 1 1 144 0 72 72 0 1 1-144 0zm200 0a128 128 0 1 0-256 0 128 128 0 1 0 256 0zm184 0a72 72 0 1 1 144 0 72 72 0 1 1-144 0zm200 0a128 128 0 1 0-256 0 128 128 0 1 0 256 0z"></path>
                            </svg><p class="text-[12px] text-black font-medium ">Bike Friendly</p></div>
                        <div class="flex items-center justify-center p-2 bg-gray-200 rounded-md "><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" stroke="currentColor" stroke-width="0" class="inline-block mr-2" viewBox="0 0 320 512"><path stroke="none" d="M160 48a48 48 0 1 1 96 0 48 48 0 1 1-96 0zm-33.5 151.3c-1 .4-1.9.8-2.9 1.2l-8 3.5c-16.4 7.3-29 21.2-34.7 38.2l-2.6 7.8c-5.6 16.8-23.7 25.8-40.5 20.2S12 246.5 17.6 229.7l2.6-7.8c11.4-34.1 36.6-61.9 69.4-76.5l8-3.5c20.8-9.2 43.3-14 66.1-14 44.6 0 84.8 26.8 101.9 67.9l15.4 36.9 21.4 10.7c15.8 7.9 22.2 27.1 14.3 42.9s-27.1 22.2-42.9 14.3L247 287.3c-10.3-5.2-18.4-13.8-22.8-24.5l-9.6-23-19.3 65.5 49.5 54c5.4 5.9 9.2 13 11.2 20.8l23 92.1c4.3 17.1-6.1 34.5-23.3 38.8s-34.5-6.1-38.8-23.3l-22-88.1-70.7-77.1c-14.8-16.1-20.3-38.6-14.7-59.7l16.9-63.5zM68.7 398l25-62.4c2.1 3 4.5 5.8 7 8.6l40.7 44.4-14.5 36.2c-2.4 6-6 11.5-10.6 16.1l-61.7 61.7c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L68.7 398z"></path>
                        </svg><p class="text-[12px] text-black font-medium ">Walker Paradise</p></div>
                    </div>
                    ...
                    <h3 class="mt-10 text-xl font-semibold text-black ">Property Facts</h3>
                    <div class="flex flex-col sm:flex-row justify-between mt-5 text-sm text-gray-600 capitalize gap-x-10">
                        <div class="flex flex-col gap-y-1 w-full sm:w-[40%]">
                            <div class="grid grid-cols-2 ">
                                <p>Status</p>
                                <p class=" text-primaryfonts">for_sale</p>
                            </div>
                            <div class="grid grid-cols-2 ">
                                <p>Community</p>
                            ...
                            <div class="grid grid-cols-2 "><p>Lot Size</p
                            ><p class=" text-primaryfonts">1,439 sqft.</p></div>
                            <div class="grid grid-cols-2 ">
                                <p>
                                    Virtual Tour</p>
                        ...
                        <div class="flex flex-col gap-y-1 w-full sm:w-[40%]">
                            ...
                            <div class="grid grid-cols-2 "><p>Year Built</p>
                            ...
                            <div class="grid grid-cols-2 "><p>Time On HomePortfolio</p>
                                <p class=" text-primaryfonts">3 days</p>
                            </div><div class="grid grid-cols-2 "><p>City</p>
                                <p class="underline cursor-pointer text-primary">Alston</p></div>
                        </div>
                    </div>
                </div>
            </CardBody>
