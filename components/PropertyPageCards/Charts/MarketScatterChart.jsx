...
import { ScatterChart, Scatter, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, defs, linearGradient, stop } from 'recharts';
    ...
    <CardBody className="w-full flex flex-col justify-between bg-white rounded-lg">
      <div className="flex justify-between items-center mb-4">
        <div className="pl-2">
          ...
          <span className="text-teal-400 font-bold">Glen Park</span>
        </div>
