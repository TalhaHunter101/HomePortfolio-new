...
export const IndivisualProprtyMapStatic = dynamic(
  () => import("./IndivisualProprtyMap"),
  {
    ssr: false,
    loading: () => (
      <div className="w-full h-full flex justify-center items-center">
...
export const PlanningApplicationMapStatic = dynamic(
  () => import("./PlanningApplicationMap"),
  {
    ssr: false,
    loading: () => (
      <div className="w-full h-full flex justify-center items-center">
...
export const RecentlySoldMapsStatic = dynamic(
  () => import("./RecentlySoldMaps"),
  {
    ssr: false,
    loading: () => (
      <div className="w-full h-full flex justify-center items-center">
