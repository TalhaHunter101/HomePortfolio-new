  ...
  return (
    <div className="flex flex-col justify-center items-center w-full">
      <p className="text-center text-lg text-default-700  mb-6">
        Lastly, please enter your <strong>full name</strong> and <strong>email</strong> so I can finish generating your report:
      </p>
      ...
      <div className="flex justify-end w-full">
        ...
        size="lg"
          ...
          disabled={isFullNameInvalid || isEmailInvalid}
        >
          View My Report
        </Button>
      </div>
