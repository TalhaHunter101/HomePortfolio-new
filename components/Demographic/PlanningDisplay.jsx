...
import {LocationOverviewCard} from "./Planning/location";
import PlanningCard from "./Planning/main";
import PlanningApplicationsTable from "./Planning/table";
import AppCard from "./Planning/appcard";
...
function PlanningDisplayLayout({}) {
  ...
  const navElements = [
    {
      ...
      subElements: [
        ...
        },
        {
          ...
          bgColor: "bg-pink-500",
          id: "schools",
          Component: PlanningApplicationsTable,
        },
        {
          name: "Gender",
          icon: "mdi:school",
...
export default PlanningDisplayLayout;
