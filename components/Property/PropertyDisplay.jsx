...

{
    element.subElements.map((subElement, subIndex) => (
      (
       <div key={subIndex} id={subElement.id}  onMouseEnter={()=> handleMouseEnter(subElement.id)} >
         <subElement.Component {...listingData} title={subElement.name} schoolData={schoolData} />
       </div>
     )
                                  ...
                                  {element.subElements.map(
                                    (subElement, subIndex) => (
                                      ...
                                      >
                                        <a
                                          href={"#" + subElement.id}
                                          onClick={() => handleMouseEnter(subElement.id)}
