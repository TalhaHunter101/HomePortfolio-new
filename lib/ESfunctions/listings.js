...
export const searchHomePageData = async (query) => {
  try {
    ...
    groupedResults.posttown = groupedResults.posttown.slice(0, 5);
    groupedResults.thoroughfare = groupedResults.thoroughfare.slice(0, 5);
    groupedResults.postcode = groupedResults.postcode.slice(0, 5);
    groupedResults.address = groupedResults.address.slice(0, 5);
