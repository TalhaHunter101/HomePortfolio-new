...
export const getSearchListingData = async (
  ...
  try {
    ...
    const searchField = type === "town"
      ? "location.townOrCity.keyword"
      : type === "county"
      ? "analyticsTaxonomy.countyAreaName.keyword"
      : ["analyticsTaxonomy.outcode.keyword", "ref_postcode.keyword", "analyticsTaxonomy.incode.keyword", "analyticsTaxonomy.countyAreaName.keyword", "location.townOrCity.keyword"];
