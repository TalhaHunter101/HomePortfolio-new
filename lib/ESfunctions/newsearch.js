...
export const getSearchListingData = async (
  ...
  try {
    ...
    } else if (houseType === "any") {
      // If houseType is "any", do not filter out any property types
      mustFilters.push({
        exists: {
          field: "adTargeting.propertyType.keyword", // Ensure the field exists to include all property types
        },
      });
    }
