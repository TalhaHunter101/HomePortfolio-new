import { Button, Card, Input, CardHeader, CardBody, Image, ButtonGroup } from "@nextui-org/react";
        ...
        <main className="flex flex-col h-screen">
            <div className="w-screen fixed flex bg-content1 z-40 justify-between items-center px-10">
                ...
                <div className="flex items-center gap-2">
                    <Button endContent={<Icon icon="ph:caret-down-fill" />}  radius="sm" size="lg" className="w-full justify-between max-w-xs" auto>Beds</Button>
                    <Button endContent={<Icon icon="ph:caret-down-fill" />}  radius="sm" size="lg" className="w-full justify-between max-w-xs" auto>Baths</Button>
                    <Button endContent={<Icon icon="ph:caret-down-fill" />}  radius="sm" size="lg" className="w-full justify-between max-w-xs" auto>Price</Button>
                    <Button endContent={<Icon icon="ph:caret-down-fill" />}  radius="sm" size="lg" className="w-full justify-between max-w-xs" auto>Home Types</Button>
                    <Button endContent={<Icon icon="ph:caret-down-fill" />}  radius="sm" size="lg" className="w-full justify-between max-w-xs" auto>Open House</Button>
                    <Button  radius="sm" size="lg" className="w-full max-w-xs" auto>Filters</Button>
                    <Button color="primary" radius="sm" size="lg" className="w-full max-w-xs m-2" auto>Save my Search</Button>
                </div>
            </div>
                ...
                <div className="w-1/2 flex flex-col p-6 overflow-y-auto ml-auto height-full">
                    <div className="flex justify-between items-center p-4">
                        ...
                        <div className="flex space-x-2">
                            <Button radius="sm"  size="lg" className="w-full max-w-xs" auto>hide map</Button>
                            <Button radius="sm"  size="lg" className="w-full max-w-xs" auto>sort</Button>
                        </div>
                    </div>

                    <div className="flex justify-between items-center p-4 w-full">
                        <ButtonGroup radius="sm"  size="lg" className="w-full border-default-300">
