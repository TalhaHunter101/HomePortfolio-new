...
import { Divider, Card, Image, Spinner } from "@nextui-org/react";
...
export default function CompareEstateAgents() {
  ...
  useEffect(() => {
    const handleSearch = async () => {
      if (postcode.length > 1) {
        ...
        try {
          const response = await fetch("/api/agents/search-agent", {
            method: "POST",
            headers: {
        ...
        console.warn("Please enter at least two characters for the search.");
      }
    };
    if (postcode.length > 1) {
      handleSearch();
  ...
  return (
    <section className="max-w-[100vw] bg-gradient-to-b from-blue-600 to-blue-500 text-white py-16 mt-16">
      <div className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between px-4 sm:px-6 lg:px-8">
        {/* Left Section */}
        <div className="w-full md:max-w-lg text-center md:text-left mb-8 md:mb-0">
          <h1 className="text-5xl font-extrabold mb-4">
            Compare Estate Agents
          </h1>
          <p className="mb-8 text-lg leading-relaxed">
            See which agents will do the best job of selling your home, based on
            past performance.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center w-full mb-8">
            <input
              ...
              className="flex-1 py-3 px-6 mb-4 sm:mb-0 rounded-full text-black text-lg placeholder-gray-500 outline-none shadow-lg"
            />
            <button
              //   onClick={handleSearch}
              className="w-full sm:w-auto sm:ml-4 bg-green-500 text-white font-semibold rounded-full px-6 py-3 hover:bg-green-600 transition-all duration-300"
            >
              Get Started
            </button>
          </div>
        ...
        <div className="w-full md:max-w-md md:ml-12 flex justify-center mb-8 md:mb-0">
          <Image
      ...
      <div className="bg-white text-black py-16 mt-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-start">
          {/* Left Text Section */}
          <div className="max-w-lg mb-8 md:mb-0">
            <h2 className="text-3xl font-bold mb-4 text-blue-900">
              Making your home sale easy
            </h2>
            <p className="mb-4 leading-relaxed">
              GetAgent.co.uk is the Estate Agent comparison site. Since 2015,
              we&apos;ve helped more than <strong>800,000 homeowners</strong>{" "}
              across the UK sell their home for the best possible price.
            </p>
            <p className="mb-4 leading-relaxed">
              We do this by analysing heaps of property data and allowing you to
              compare Estate Agent performance.
            </p>
          </div>
          ...
          <div className="flex-1 mx-8">
            <div className="bg-blue-50 rounded-lg p-6 mb-6 shadow-md">
              <blockquote className="text-xl font-semibold mb-4 text-blue-800 leading-relaxed">
                &quot;My house was on the market for a year with no success. I
                used GetAgent.co.uk to find a new agent and we sold in a few
                weeks with two offers!&quot;
              </blockquote>
              <p className="text-right text-blue-700">- Mr Haile</p>
            </div>
      ...
      {/* Steps Section */}
      <div className="bg-blue-200 text-black py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {stepsData.map((step) => (
              <Card
                key={step.id}
                className="flex flex-col bg-gradient-to-b from-blue-100 to-blue-200 items-center p-8 rounded-lg border-border-gray-200 shadow-md"
              >
                <div className="rounded-full bg-blue-500 text-white w-12 h-12 flex items-center justify-center mb-4 text-lg font-bold shadow-md">
                  {step.id}
                </div>
                <h3 className="text-xl font-semibold mb-2 text-blue-800">
                  {step.title}
                </h3>
                <p className="text-center text-blue-700">{step.description}</p>
              </Card>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {locations.map((location) => (
              <div
                key={location.id}
                className="flex justify-between items-center p-6 bg-gray-100 rounded-lg shadow-md hover:bg-gray-200 transition-all duration-300 cursor-pointer"
              >
        ...
        <div className="container mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center w-full max-w-xl">
            ...
            <button
              ...
              className="ml-0 sm:ml-4 bg-green-500 text-white font-semibold rounded-full px-6 py-3 hover:bg-green-600 transition-all duration-300"
            >
              Compare Agents
            </button>
          </div>
