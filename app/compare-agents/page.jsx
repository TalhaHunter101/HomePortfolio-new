        ...
        <section className="max-w-[100vw] bg-gradient-to-b from-blue-600 to-blue-500 text-white py-16 mt-16">
            <div className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="w-full md:max-w-lg text-center md:text-left mb-8 md:mb-0">
                    <h1 className="text-5xl font-extrabold mb-4">Compare Estate Agents</h1>
            ...
            <div className="bg-white text-black py-16 mt-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-start">
                    ...
                    <div className="max-w-lg mb-8 md:mb-0">
                        <h2 className="text-3xl font-bold mb-4 text-blue-900">Making your home sale easy</h2>
            ...
            <div className="bg-blue-200 text-black py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-semibold text-center mb-8 text-blue-900">How to Pick the Best Estate Agent</h2>
            ...
            <div className="bg-white text-black py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-semibold text-center mb-8 text-blue-900">Find an Estate Agent Near You</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {locations.map((location) => (
                            ...
                            >
                                <span className="text-lg font-medium text-blue-800">{location.name}</span>
                                <svg
